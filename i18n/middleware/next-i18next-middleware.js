...
var _utils = require('next-i18next/dist/commonjs/utils');
...
function _default(nexti18next) {
    ...
    var localeSubpathRoute = route(
        '/:subpath('.concat(Object.values(localeSubpaths).join('|'), ')(.*)')
    );
    var middleware = [];
    /*
  ...
  */
    ...
    middleware.push(_cjs['default'].handle(i18n, config));
    /*
  ...
  */
    ...
    middleware.push(function(req, res, next) {
        if (isI18nRoute(req) && req.i18n) {
            ...
            var currentLngSubpath = (0, _utils.subpathFromLng)(
                config,
                currentLng
            );
            var currentLngRequiresSubpath = (0, _utils.subpathIsRequired)(
                config,
                currentLng
            );
            var currentLngSubpathIsPresent = (0, _utils.subpathIsPresent)(
                req.url,
                currentLngSubpath
            );
            var lngFromCurrentSubpath = allLanguages.find(function(l) {
                return (0,
                _utils.subpathIsPresent)(req.url, (0, _utils.subpathFromLng)(config, l));
            });
        ...
        */
                return (0, _utils.redirectWithoutCache)(
                    res,
                    (0, _utils.addSubpath)(req.url, currentLngSubpath)
                );
            }
            /*
